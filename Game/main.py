...
rec_BL = pygame.image.load(os.path.join("weapons", "rect_blue_laser.png"))
rec_RL = pygame.image.load(os.path.join("weapons", "rect_red_laser.png"))
...
BLUE_LASER = pygame.image.load(os.path.join("weapons", "pixel_laser_blue.png"))

BG = pygame.transform.scale(pygame.image.load(os.path.join("BG", "background1.png")), (Width, Height))
